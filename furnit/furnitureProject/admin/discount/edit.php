...
$disData = mysqli_fetch_assoc($op);
 ...
 if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(!Validate($percent,1)){
        $errors['Price'] = " Price Required"; 
    } elseif (!Validate($percent, 4)) {
        $errors['Price'] = " Invalid Price";
    }

    if (!Validate($pro_id,1)) {
        $errors['Product'] = " Product Required";
    } elseif (!Validate($pro_id, 4)) {
        $errors['Product'] = " Product Invalid";
    }
    if(!Validate($selected_radio,1)){
        ...
        <div class="container">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="radio" id="activeChoice1" name="active" <?php if ($disData['active']== "Active") echo "checked";?> value="Active">
                    <label for="activeChoice2">Not Active</label>
                    <input type="radio" id="activeChoice2" name="active" <?php if ($disData['active']== "Inactive") echo "checked";?> value="Inactive">                    
                </div>
