...
$orderdata = mysqli_fetch_assoc($Orderop);
    ...
    ?>
           <div>
           <a href="category.php"> <button type="button" > Continue Shopping </button> </a>
           <a href="checkout.php?order_id=<?php echo $_SESSION['User']['id'];?>"> <button type="button" > Checkout </button> </a>
           </div>
